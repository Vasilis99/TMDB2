...
class TVShowsShimmer(context: Context) : ShimmerFrameLayout(context) {
    ...
    init {
        ...
        tvShowViews.add(ConstraintLayout(context).apply{id=View.generateViewId()}.apply {
            setBackgroundColor(Color.GRAY)
        ...
        tvShowViews.add(Button(context).apply{id=View.generateViewId()}.apply {
